...
油猴给我们提供了一个 `@require` 属性给我们来引用用户脚本，并且油猴给我们提供了`md5`，`sha512`等校验方法来校验引用的脚本是否正确。

* [md5 生成工具](https://emn178.github.io/online-tools/md5_checksum.html)
* [sha512 生成工具](https://emn178.github.io/online-tools/sha512_file_hash.html)

例如下面这样:

```js
// @require      https://cdn.jsdelivr.net/npm/vue@2.6.12/dist/vue.min.js#md5=fb192338844efe86ec759a40152fcb8e
```
